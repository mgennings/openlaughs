...
import { updateUserActivity } from "../graphql/mutations";
...
export default function UserActivityUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setActivityType(cleanValues.activityType);
      ...
      const record = idProp
        ? (
            await client.graphql({
              query: getUserActivity.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: updateUserActivity.replaceAll("__typename", ""),
            variables: {
              input: {
                id: userActivityRecord.id,
                ...modelFields,
              },
            },
          });
