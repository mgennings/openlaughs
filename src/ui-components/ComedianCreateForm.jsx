...
export default function ComedianCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setNotableCredits(initialValues.notableCredits);
    setCurrentNotableCreditsValue("");
    setAwards(initialValues.awards);
    setCurrentAwardsValue("");
    setPressKitUrl(initialValues.pressKitUrl);
    setVideoSampleUrl(initialValues.videoSampleUrl);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createComedian.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "ComedianCreateForm")}
      {...rest}
    >
      <TextField
        label="Stage name"
