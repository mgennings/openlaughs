...
import { createFavoriteComedian } from "../graphql/mutations";
const client = generateClient();
export default function FavoriteComedianCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setComedianId(initialValues.comedianId);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createFavoriteComedian.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "FavoriteComedianCreateForm")}
      {...rest}
    >
      <TextField
