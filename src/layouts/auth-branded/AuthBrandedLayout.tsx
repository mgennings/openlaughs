  ...
  return (
    <Fragment>
      ...
      <div className="grid lg:grid-cols-2 grow">
        <div className="flex justify-center items-center p-4 md:p-10 order-2 lg:order-1">
          <Outlet />
        </div>
          ...
          <div className="flex flex-col p-8 mx-auto lg:p-16 gap-4 bg-black/95 card max-w-[420px] w-full">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="text-base font-medium text-gray-100">
                Join Austin's comedy community and discover, connect, and laugh
                together. Your gateway to
